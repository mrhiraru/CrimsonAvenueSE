                        ...
                        <form action="" method="post" class="col-12" id="orderForm">
                            ...
                            <div class="col-12 m-0 mb-1 p-0 d-flex flex-row flex-wrap align-items-center text-secondary">
                                ...
                                ?>
                                        ...
                                        if (!isset($_SESSION['college_name']) && isset($record['college_name']) && $record['exclusivity'] == $record['college_name']) {
                                        ?>
                                            <div class="col-12 m-0 p-0 me-1 mt-2 d-flex justify-content-evenly">
                                                This product is exclusive only for <?= $record['college_name'] ?> users.
                                            </div>
                                        <?php
                                        } else if (isset($record['college_name']) && ($record['exclusivity'] != $_SESSION['college_name'] && $record['exclusivity'] == $record['college_name'])) {
                                        ?>
                                            <div class="col-12 m-0 p-0 me-1 mt-2 d-flex justify-content-evenly">
                                                This product is exclusive only for <?= $record['college_name'] ?> users.
                                            </div>
