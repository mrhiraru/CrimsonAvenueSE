                        ...
                        <tbody>
                            ...
                            $messageArray = array(
                                array(
                                    ...
                                    'name' => 'Franklin Oliveros (Store-owner)',
                                    'number' => 8,
                                ),
                            );
                            ?>
                            ...
                            ?>
                                ...
                                <tr class="align-middle">
                                    ...
                                    <td><?= $item['name'] ?></td>
                                    <td><?= $item['number'] ?></td>
                                    <td class="text-center"><a href="message.php" class="rounded py-1 px-2 btn-white text-secondary text-decoration-none">View Messages</a></td>
                                </tr>
