                ...
                <div class="modal-body">
                    <form method="post" action="" class="row d-flex">
                        <div class="mb-2 col-12">
                            ...
                            <input type="text" class="form-control" id="name" name="name" placeholder="Franklin Oliveros" required>
                            <p id="store-name-error" class="modal-error text-danger my-1 d-none">Your custom error message here</p>
                        </div>

                        <div class="mb-2 col-12">
                            <label for="subject" class="form-label">Subject: </label>
                            <input type="text" class="form-control" id="subject" name="subject" placeholder="Need Help" required>
                            <p id="store-name-error" class="modal-error text-danger my-1 d-none">Your custom error message here</p>
                        </div>
