                ...
                <main class="col-md-9 col-lg-10 p-4 row m-0 h-100">
                    ...
                    <div class="container-fluid bg-white shadow rounded m-0 mt-4 p-3" id="Descriptions">
                        <div class="row d-flex justify-content-between m-0 p-0">
                            ...
                            <form method="post" action="<?= './product-view.php?store_id=' . $record['store_id'] . '&product_id=' . $pro_record['product_id'] . '&desc_id=null' . '#Descriptions' ?>" class="col-12 col-lg-6">
                                <div class="row">
                    ...
                    <div class="container-fluid bg-white shadow rounded m-0 mt-4 p-3" id="Variations">
                        <div class="row d-flex justify-content-between m-0 p-0">
                            ...
                            <form method="post" action="<?= './product-view.php?store_id=' . $record['store_id'] . '&product_id=' . $pro_record['product_id'] . '&variation_id= ' . '#Variations' ?>" class="col-12 col-lg-6">
                                <div class="row">
                                    <div class="input-group mb-2 p-0 col-12">
                                        <?php
